/*! Granim v1.0.6 - https://sarcadass.github.io/granim.js */ ! function t(e, s, i) {
    function n(a, r) {
        if (!s[a]) {
            if (!e[a]) {
    ...
    14: [function(t, e, s) {
        ...
        e.exports = function(t) {
            ...
            this.isCleared || (e || (this.isPaused = !0), cancelAnimationFrame(this.animation))
        }
    }, {}],
    15: [function(t, e, s) {
        "use strict";
    ...
    16: [function(t, e, s) {
        ...
        e.exports = function(t) {
            var e = "isPausedBecauseNotInView" === t;
            e || (this.isPaused = !1), this.isCleared = !1, this.animation = requestAnimationFrame(this.animateColors.bind(this))
        }
    }, {}],
    17: [function(t, e, s) {
        "use strict";
        e.exports = function(t) {
            ...
            this.activeColors.forEach(function(n, o, a) {
                for (s = 0; s < 3; s++) e = i.activeColors[o][s] + Math.ceil(i.activeColorDiff[o][s] / 100 * t), e <= 255 && e >= 0 && (i.currentColors[o][s] = e)
            }), this.makeGradient()
        }
    }, {}],
    18: [function(t, e, s) {
