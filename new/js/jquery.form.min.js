...
! function(a) {
    "use strict";
    "function" == typeof define && define.amd && define(["jquery"], a), a("undefined" != typeof module ? require("jquery") : "undefined" != typeof jQuery ? jQuery : window.Zepto)
}(function(a) {
    "use strict";
    ...
    a.fn.attr2 = function() {
        ...
        function i(c) {
            var d, e, f = a.param(c, b.traditional).split("&"),
                g = f.length,
                h = [];
            for (d = 0; d < g; d++) e = f[d].split("="), h.push([decodeURIComponent(e[0]), decodeURIComponent(e[1])]);
            return h
        }
        ...
        function k(c) {
            ...
            function g() {
                ...
                try {
                    if (k.extraData)
                        for (var m in k.extraData) k.extraData.hasOwnProperty(m) && (a.isPlainObject(k.extraData[m]) && k.extraData[m].hasOwnProperty("name") && k.extraData[m].hasOwnProperty("value") ? j.push(a('<input type="hidden" name="' + k.extraData[m].name + '">').val(k.extraData[m].value).appendTo(x)[0]) : j.push(a('<input type="hidden" name="' + m + '">').val(k.extraData[m]).appendTo(x)[0]));
                    k.iframeTarget || p.appendTo("body"), q.attachEvent ? q.attachEvent("onload", h) : q.addEventListener("load", h, !1), setTimeout(b, 15);
                    try {
                        x.submit()
                    } catch (a) {
                    ...
                    x.setAttribute("action", f), x.setAttribute("enctype", i), c ? x.setAttribute("target", c) : o.removeAttr("target"), a(j).remove()
                }
            }

            function h(b) {
                if (!r.aborted && !F) {
                    if (E = e(q), E || (d("cannot access response document"), b = A), b === z && r) return r.abort("timeout"), void y.reject(r, "timeout");
            ...
            if (k = a.extend(!0, {}, a.ajaxSettings, b), k.context = k.context || k, n = "jqFormIO" + (new Date).getTime(), k.iframeTarget ? (p = a(k.iframeTarget), u = p.attr2("name"), u ? n = u : p.attr2("name", n)) : (p = a('<iframe name="' + n + '" src="' + k.iframeSrc + '" />'), p.css({
                    position: "absolute",
                    top: "-1000px",
                    left: "-1000px"
                })), q = p[0], r = {
            ...
            t = x.clk, t && (u = t.name, u && !t.disabled && (k.extraData = k.extraData || {}, k.extraData[u] = t.value, "image" == t.type && (k.extraData[u + ".x"] = x.clk_x, k.extraData[u + ".y"] = x.clk_y)));
            var z = 1,
                A = 2,
        ...
        "function" == typeof b ? b = {
            ...
            data: c,
            dataType: g
        }, "function" == typeof h && (b.success = h)) : void 0 === b && (b = {}), l = b.type || this.attr2("method"), m = b.url || this.attr2("action"), n = "string" == typeof m ? a.trim(m) : "", n = n || window.location.href || "", n && (n = (n.match(/^([^#]+)/) || [])[1]), b = a.extend(!0, {
            url: n,
        ...
        if (b.resetForm && w.push(function() {
            ...
            w.push(function(c) {
                ...
                a(b.target)[d](c).each(x, arguments)
            })
        ...
        var g, h = this[0],
            i = this.attr("id"),
            j = b ? h.getElementsByTagName("*") : h.elements;
        if (j && (j = a.makeArray(j)), i && (g = a(':input[form="' + i + '"]').get(), g.length && (j = (j || []).concat(g))), !j || !j.length) return f;
        ...
        } else null !== n && "undefined" != typeof n && (c && c.push(o), f.push({
            name: m,
            value: n,
            type: o.type,
            required: o.required
